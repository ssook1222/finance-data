...
# 이상치 제거를 위한 상하위 1% 확인
quantile(enterprise$X.영업이익총액, probs=c(0.01, 0.99))

# 영업이익총액 이상치 제거(상하위 1%)
enterprise$X.영업이익총액 <- ifelse(enterprise$X.영업이익총액 < -2577968 | enterprise$X.영업이익총액 > 58797459, NA, enterprise$X.영업이익총액)
enterprise <- enterprise[ complete.cases(enterprise[ , c("X.영업이익총액")]), ]
